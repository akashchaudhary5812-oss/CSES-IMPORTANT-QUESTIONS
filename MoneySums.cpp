...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
int dp[101][100001];
int helper(int i, int n, vector<int>& arr, int s, set<int>& h){
    if(i >= n){
        debug(s)
        h.insert(s);
        return 0;
    ...
    int way1 = helper(i + 1,n,arr,s - arr[i],h);
    int way2 = helper(i + 1,n,arr,s,h);
    return dp[i][s] = (way1 + way2);
}
void solve() {
     int tc;
     tc = 1;
